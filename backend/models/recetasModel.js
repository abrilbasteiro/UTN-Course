const router = require('../routes/admin/recetas');
var pool = require('./bd');
...
async function updateRecetaById(obj, id){
    try {
...
module.exports = { getRecetas, insertReceta, deleteRecetaById, getRecetaById, updateRecetaById }